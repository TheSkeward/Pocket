...
async def on_message(message: discord.Message):
    ...
    if not message.author.id in ignore_list:
        ...
        if addressed:
            content = content[7:].strip()           # Remove the prefix ("pocket," or "Pocket:"), which is 5 chars long
...
def is_addressed(message: discord.Message):
    """
    Determines if Pocket was addressed, ie "Pocket, inspire me" or "pocket: give me a suggestion"
